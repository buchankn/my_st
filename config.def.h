 ...
 */
/* static char *font = "SauceCodePro Nerd Font:pixelsize=33:antialias=true:autohint=true"; */
static char *font = "SourceCodePro:pixelsize=33:antialias=true:autohint=true";
